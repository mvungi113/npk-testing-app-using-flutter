    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title:
                  Text('Ingia kwenye Akaunti', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold, ),),
            ),
                  ...
                  children: [
                   ...
                   Padding(padding: EdgeInsets.fromLTRB(20, 0, 20, 20),
                    child:  Container(
                      ...
                      validator: (value) {
                        if (value!.isEmpty) {
                          return 'Tafadhali ingiza akaunti yako';
                        }
                        return null;
                      },
                      onSaved: (val) {
                   ...
                   Padding(padding: EdgeInsets.fromLTRB(20, 0, 20, 20),
                    child: Container(
                      ...
                      child: ElevatedButton(
                       ...
                       child: Text('INGIA', style: TextStyle(color: Colors.white, fontSize: 20.0, fontWeight: FontWeight.w600)),),
                    ),
                  ),
                  ],
                ),
