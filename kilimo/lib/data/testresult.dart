    ...
    if (data['error']) {
      ...
      return Column(children: [
        ...
        Container(
          ...
          children: [
            Text(
              'Vigezo Vya Uchambuzi Wa Udongo',
              style: TextStyle(
                color: Colors.black,
                fontSize: 20,
                fontWeight: FontWeight.bold,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Nitrogen Chini ya 50 ppm (N < 50 ppm)',
                        ...
                        Text(
                          'Phosphorus Chini ya 4 ppm (P < 4 ppm)',
                          style: TextStyle(color: Colors.white, fontSize: 16),
                        ),
                        SizedBox(
                          height: 5,
                        ...
                        Text(
                          'Potassium Chini ya 50 ppm (K < 50 ppm)',
                          style: TextStyle(color: Colors.white, fontSize: 16),
                        ),
                        SizedBox(
                          height: 10,
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                'Nitrogen Kubwa Zaidi ya 200 ppm (N > 50 ppm)',
                                style: TextStyle(
                              ...
                              Text(
                                'Phosphorus Kubwa Zaidi ya 14 ppm (P > 4 ppm)',
                                style: TextStyle(
                                    color: Colors.white, fontSize: 16),
                              ),
                              SizedBox(
                              ...
                              Text(
                                'Potassium Kubwa Zaidi ya 200 ppm (K > 50 ppm)',
                                style: TextStyle(
                                    color: Colors.white, fontSize: 16),
                              ),
                              SizedBox(
